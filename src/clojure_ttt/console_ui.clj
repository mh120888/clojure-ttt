...
(defn do-you-want-to-go-first
  ([io-channel] (do-you-want-to-go-first io-channel "Do you want to go first? Please enter y (yes) or n (no)."))
  ([io-channel message]
...
(defn get-board-size
  ([io-channel] (get-board-size io-channel "What size board would you like to play on? 3x3 (3) or 4x4 (4)?"))
  ([io-channel message]
    (let [response (get-user-input io-channel message)]
...
(defn get-human-marker
  ([io-channel] (get-human-marker io-channel "Which marker would you like to use, \"x\" or \"o\"?"))
  ([io-channel message]
    (let [response (get-user-input io-channel message)]
